...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeSize:_mapTileSize forKey:@"TMXLayerTileSize"];
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if(self = [super initWithCoder:aDecoder])
    {
        ...
        _mapTileSize = [aDecoder decodeSizeForKey:@"TMXLayerTileSize"];
...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeSize:_layerGridSize forKey:@"TMXLayerInfoGridSize"];
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if(self = [super init])
    {
        ...
        _layerGridSize = [aDecoder decodeSizeForKey:@"TMXLayerInfoGridSize"];
...
-(void)setSourceImage:(NSString *)sourceImage
{
    ...
    NSImage* atlas = [[NSImage alloc] initWithContentsOfFile:_sourceImage];
...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeSize:_tileSize forKey:@"TMXTilesetTileSize"];
    [aCoder encodeSize:_unitTileSize forKey:@"TMXTilesetUnitTileSize"];
    ...
    [aCoder encodeSize:_imageSize forKey:@"TMXTilesetImageSize"];
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if(self = [super init])
    {
        ...
        _tileSize = [aDecoder decodeSizeForKey:@"TMXTilesetTileSize"];
        _unitTileSize = [aDecoder decodeSizeForKey:@"TMXTilesetUnitTileSize"];
        ...
        _imageSize = [aDecoder decodeSizeForKey:@"TMXTilesetImageSize"];
...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeSize:_mapSize forKey:@"JSTileMapMapSize"];
    [aCoder encodeSize:_tileSize forKey:@"JSTileMapTileSize"];
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if(self = [super initWithCoder:aDecoder])
    {
        _mapSize = [aDecoder decodeSizeForKey:@"JSTileMapMapSize"];
        _tileSize = [aDecoder decodeSizeForKey:@"JSTileMapTileSize"];
